var events = [
  {'Date': new Date(2018, 5, 07), 'Title': 'Preparedness Measures and Effects of Southwest Monsoon Enhanced by Typhoon Domeng', 'Link': function(){$('#modalDomeng').modal('show');}},
  {'Date': new Date(2018, 1, 12), 'Title': 'Preparedness and Measures of Tropical Storm "BASYANG" (I.N. SANBA) ', 'Link': function(){$('#modalBasyang').modal('show');}},
  ...
  {'Date': new Date(2018, 5, 09), 'Title': 'HelloModal', 'Link': ''},
